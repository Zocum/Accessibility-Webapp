  ...
  try {
    ...
    const crawler = new PuppeteerCrawler({
      ...
      requestHandler: async ({ request, log }) => {
        ...
        let levelATotal = 0, levelAFailed = 0;
        let levelAATotal = 0, levelAAFailed = 0;
        ...
        results.levelAScore = levelATotal > 0 ? 1 - (levelAFailed / levelATotal) : 1;
        results.levelAAScore = levelAATotal > 0 ? 1 - (levelAAFailed / levelAATotal) : 1;
      }
    });
